...
public class LocalizationFragment extends Fragment implements OnNetworkChangeListener {

    private static final String TAG = LocalizationFragment.class.getName();
